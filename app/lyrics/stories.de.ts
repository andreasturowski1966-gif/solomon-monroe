...
export const germanSongStories: Record<string, SongStory> = {
  "aint-easy-at-all": {
    teaser:
  ...
  "lets-sing-about-freedom": {
    teaser:
      "Ein Song über freie Meinungsäußerung und die Einsicht, dass Freiheit und Verantwortung zusammengehören.",
    paragraphs: [
      "Ich bin kein besonders politischer Mensch. Aber manche Dinge sind mir wichtig genug, dass ich meinen Senf dazugeben möchte. Seine Meinung sagen zu können, ohne öffentlich an den Pranger gestellt oder vom Staat behelligt zu werden, bedeutet mir sehr viel.",
      "Versteht mich nicht falsch: Freiheit darf keine Entschuldigung dafür sein, jede Grenze zu überschreiten. Sagt eure Meinung, aber benutzt sie nicht, um andere zu verletzen. Das sage ich aus tiefstem Herzen.",
    ],
  },
  ...
  "my-little-miracle": {
    teaser:
      "Das Lied eines Vaters für die Tochter, deren Ankunft alles veränderte.",
    paragraphs: [
      "Die Geburt meiner Tochter war der größte und schönste Augenblick meines Lebens. Ich glaube, jeder Vater, der in diesem Raum gestanden hat, versteht das.",
      "Mein tiefster Wunsch war wahr geworden. Diesen außergewöhnlichen Menschen in meinem Leben zu haben, fühlt sich bis heute wie ein Wunder an.",
    ],
  },
  "no-one-wins-tonight": {
    teaser:
  ...
  "sometimes-everybody-needs-a-friend": {
    teaser:
      "Eine einfache Erinnerung daran, dass auch Menschen, die alles im Griff zu haben scheinen, jemanden an ihrer Seite brauchen.",
    paragraphs: [
      "Hier gibt es keine komplizierte Geschichte, nur eine Botschaft, an die ich glaube.",
      "Wir stellen uns oft vor, bestimmte Menschen hätten es im Leben viel leichter als wir. Ich kann euch versichern: Auch Gewinner und Überflieger erleben schwere Zeiten. Dann brauchen auch sie einen Freund. Das gilt für uns alle.",
    ],
  },
  "take-me-back-home-again": {
    teaser:
      "Eine Sommererinnerung und die Erkenntnis, dass Heimat nicht immer ein Ort ist.",
    paragraphs: [
      "Dies ist ein einfacher Song über eines der schönsten Geschenke, die wir bekommen: unsere Erinnerungen. Heimat ist kein Ort. Sie ist ein Gefühl.",
      "Ich schreibe nicht über das allererste Mal, als ich mich in ein Mädchen verliebte – damals war ich noch in der Junior High, und niemand fuhr mit Daddys Auto herum. Aber als ich sechzehn war, bevor ich meine erste Frau kennenlernte, gab es ein Mädchen. Es war Sommer und … nun, hört euch den Song an.",
    ],
  },
  "tell-me-the-truth": {
    teaser:
  ...
  "this-is-what-our-love-was-meant-to-be": {
    teaser:
      "Ein Soul-Song mit Achtzigerklang über die Ehe als Versprechen, das vom wirklichen Leben geprüft – und gehalten – wird.",
    paragraphs: [
      "Soul mit einem Hauch der Achtziger – genau das hört ihr, und genau so sollte es klingen. Doch für mich trägt der Song noch etwas Wichtigeres.",
      "Eine Ehe ist mehr als eine Beziehung, eine Romanze oder gemeinsam verbrachte Zeit. Sie ist ein großes Versprechen. Meine zweite Ehe beweist das seit mehr als zwei Jahrzehnten. Wir haben unsere Eltern beerdigt und schwere Krankheiten durchgestanden. Ich glaube, Gott hat uns genau für diese Tage zusammengeführt, damit keiner von uns sie allein bewältigen musste.",
    ],
  },
  "those-were-the-days": {
    teaser:
  ...
  "you-loved-me-all-along": {
    teaser:
      "Ein Song für Solomons Vater – fünfzehn Jahre nach seinem Tod noch immer nah genug, um weh zu tun.",
    paragraphs: [
