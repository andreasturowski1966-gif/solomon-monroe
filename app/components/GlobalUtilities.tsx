    ...
    <>
      <div className="border-t border-white/6 bg-[#0d0b09] px-5 py-5 text-center">
        <p className="text-[0.65rem] leading-5 text-white/28">
          {isGerman
            ? "Teile der Inhalte dieser Website wurden mit Unterstützung künstlicher Intelligenz erstellt."
            : "Portions of this website's content were created with the assistance of artificial intelligence."}
        </p>
        <div className="mt-3 flex flex-wrap justify-center gap-x-5 gap-y-2">
          <Link
            href={isGerman ? "/de/impressum" : "/impressum"}
            className="text-[0.6rem] uppercase tracking-[0.18em] text-white/30 transition-colors hover:text-white/60"
          >
            Legal Notice / Impressum
          </Link>
          <Link
            href={isGerman ? "/de/datenschutz" : "/datenschutz"}
            className="text-[0.6rem] uppercase tracking-[0.18em] text-white/30 transition-colors hover:text-white/60"
          >
      ...
      <a
        ...
        aria-label={
          isGerman
            ? "Solomon Monroe über Messenger schreiben"
            : "Message Solomon Monroe on Messenger"
        }
      ...
      >
        ...
        <span className="hidden sm:inline">
          {isGerman ? "Solomon schreiben" : "Message Solomon"}
        </span>
      </a>
    </>
  );
